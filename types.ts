...
/**
 * Partial analysis result for streaming updates.
 * All fields are optional to allow incremental updates.
 */
export interface PartialCodeAnalysisResult {
  summary?: string;
  architecture?: string;
  techStack?: string[];
  graphData?: GraphData;
...
/**
 * Streaming update emitted by the orchestrator
 */
export interface StreamingAnalysisUpdate {
  stage: AgentStage;
  message: string;
  partialResult: PartialCodeAnalysisResult;
}
