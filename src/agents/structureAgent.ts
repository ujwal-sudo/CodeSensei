...
export const runStructureAgent = async (chunks: CodeChunk[]): Promise<StructureOutput> => {
  ...
  // Use STANDARD tier for high-volume structure analysis
  return callGeminiAgent<StructureOutput>(AGENT_PROMPTS.STRUCTURE, context, schema, 0.1, MODELS.STANDARD, ModelTier.STANDARD);
};